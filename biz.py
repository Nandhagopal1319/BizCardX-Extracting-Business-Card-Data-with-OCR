...
def data_extract_from_mongodb():
    nandha = pymongo.MongoClient(
        "mongodb+srv://Nandhagopal:nandhagopals@cluster1319.eiyoba2.mongodb.net/?retryWrites=true&w=majority")
    db = nandha['bizcardx']
    col = db['image_data']
...
def image_decoded(image_name, user_name, password):
    nandha = psycopg2.connect(host='localhost',
                        user='postgres',
                        password='Nandha@1997',
                        database='bizcardx')
    cursor = nandha.cursor()
